...
cli_command(__name__, 'appservice plan apps list', custom_path + 'list_apps_service_plan', exception_handler=ex_handler_factory())
cli_command(__name__, 'appservice plan apps restart', custom_path + 'restart_apps_service_plan', exception_handler=ex_handler_factory())
cli_command(__name__, 'appservice plan apps start', custom_path + 'start_apps_service_plan', exception_handler=ex_handler_factory())
cli_command(__name__, 'appservice plan apps stop', custom_path + 'stop_apps_service_plan', exception_handler=ex_handler_factory())
